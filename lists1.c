 ...
 * @h:variable of pointer to first node
 *
 * Return:value of size of list
 */
 ...
 * @h: variable pointer to first node
 *
 * Return: value of size of list
 */
 ...
 *  starts with prefix
 * @node: variable pointer to list head
 * @prefix: variable string to match
 * @c: variable of the next character after prefix to match
 *
 * Return:value match node or null
 */
 ...
 *
 * Return: value index of node or -1
 */
